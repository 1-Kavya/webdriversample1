...
//      driver.get("https://danube-webshop.herokuapp.com/");
	  extentTest = extentReports.createTest("Crime & Thrillers Test");
...
//	  driver.get("https://danube-webshop.herokuapp.com/");
		extentTest = extentReports.createTest("Horror Test");
  ...
  public void StoriesSearch() {
	  ...
	  extentTest = extentReports.createTest("Novel & Stories Test");
//      driver.get("https://danube-webshop.herokuapp.com/");
