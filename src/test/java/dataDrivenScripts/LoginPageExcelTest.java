...
public class LoginPageExcelTest {
	WebDriver driver;
	Properties prop;	
	@BeforeMethod
	...
	//properties file for env
	//csv as data input file
	//dataprovider for getting the data from csv file
	//excel as object repository


	@Test(dataProvider = "loginData") //csv file name
  public void validLogin(String strUser, String strPwd) {
	  driver.get(prop.getProperty("url"));
	  driver.findElement(By.id(readObjPath("loginUser"))).sendKeys(strUser);  //getting from excel and read object
	  ...
	  boolean isValidUser = driver.findElement(By.cssSelector(readObjPath("succssMsg"))).isDisplayed();
